...
BEGIN_MESSAGE_MAP(CCSOHotkeyApp, CWinApp)
...
// 唯一一個 CCSOHotkeyApp 物件

CCSOHotkeyApp theApp;


// CCSOHotkeyApp 初始化

BOOL CCSOHotkeyApp::InitInstance()
{
